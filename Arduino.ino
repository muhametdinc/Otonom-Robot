...
void loop() {
//Serial.println("ESP32'den veri almaya çalışıyor ");
// Eğer ESP32'den veri varsa oku

String istasyon="";

  if (Serial2.available()) {
    String veri = Serial2.readStringUntil('\n');
    /*Serial.println("veri: "+veri);
    Serial.println(veri.length());*/
    if(veri.length()==10)
    {
      istasyon=veri;
       Serial.println("İstasyon: "+istasyon);
    }
      //Serial.println("ESP32'den gelen veri: "+veri);
